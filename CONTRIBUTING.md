Contributing to VHS Core
============================

The VHS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VHS Core project, and is not to be
confused with overall VHS Network Protocol consensus changes.

Whether a pull request is merged into VHS Core rests with the project merge
...
Patches that change VHS consensus rules are considerably more involved than
...
Where a patch set proposes to change the VHS consensus, it must have been
...
The project leader is the release manager for each VHS Core release.
