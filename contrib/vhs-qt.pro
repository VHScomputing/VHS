...
RESOURCES += src/qt/vhs.qrc src/qt/vhs_locale.qrc

TRANSLATIONS += src/qt/locale/vhs_bg.ts \
                src/qt/locale/vhs_de.ts \
                src/qt/locale/vhs_en.ts \
                src/qt/locale/vhs_es.ts \
                src/qt/locale/vhs_fi.ts \
                src/qt/locale/vhs_fr.ts \
                src/qt/locale/vhs_it.ts \
                src/qt/locale/vhs_ja.ts \
                src/qt/locale/vhs_pl.ts \
                src/qt/locale/vhs_pt.ts \
                src/qt/locale/vhs_ru.ts \
                src/qt/locale/vhs_sk.ts \
                src/qt/locale/vhs_sv.ts \
                src/qt/locale/vhs_vi.ts \
                src/qt/locale/vhs_zh_CN.ts \
                src/qt/locale/vhs_zh_TW.ts
