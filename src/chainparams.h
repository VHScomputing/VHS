 ...
 * VHS system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& xVHSDevKey() const { return vVHSDevKey; }
    const std::vector<unsigned char>& xVHSFundKey() const { return vVHSFundKey; }
    ...
    //CAmount SubsidyValue(CurrentBlock) const;
...
protected:
    ...
    std::vector<unsigned char> vVHSDevKey;
    std::vector<unsigned char> vVHSFundKey;
    int nDevFee;
    int nFundFee;
    int nDefaultPort;
