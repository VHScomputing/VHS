...
/** VHS unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    static QString floorHtmlWithoutUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorNever);
