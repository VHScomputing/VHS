...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VHS);
   // unitlist.append(mVHS);
   // unitlist.append(uVHS);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VHS:
            return QString("VHS");
        case mVHS:
            return QString("Milli-VHS (1 / 1" THIN_SP_UTF8 "000)");
        case uVHS:
            return QString("Micro-VHS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VHS:
            return QString("TestVHSs");
        case mVHS:
            return QString("Milli-TestVHSs (1 / 1" THIN_SP_UTF8 "000)");
        case uVHS:
            return QString("Micro-TestVHSs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
