...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VHS);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeUccAmount"))
        SoftSetArg("-anonymizevhsamount", settings.value("nAnonymizeUccAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in vhs.cpp during shotdown to also remove the window positions
