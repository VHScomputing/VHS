...
QFontDatabase::addApplicationFont(":/fonts/vhs_font");

QString windowTitle = tr("VHS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VHS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VHS: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VHS Core"), this);
    aboutAction->setStatusTip(tr("Show information about VHS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VHS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VHS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VHS addresses"));
    ...
    openAction->setStatusTip(tr("Open a VHS: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the VHS Core help message to get a list with possible VHS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VHS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VHS network", "", count));
}
...
{
    QString strTitle = tr("VHS Core"); // default title
