...
{
public:
    /// Is the inputs associated with this public key? (and there is deposit VHS amount - checking if valid masternode)
    ...
    /// Verify the message, returns true if svhscessful
...
public:
    ...
    /// Get the denominations for a specific amount of VHS.
