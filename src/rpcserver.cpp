...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VHS features */
        {"vhs", "masternode", &masternode, true, true, false},
        {"vhs", "listmasternodes", &listmasternodes, true, true, false},
        {"vhs", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vhs", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vhs", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vhs", "masternodedebug", &masternodedebug, true, true, false},
        {"vhs", "startmasternode", &startmasternode, true, true, false},
        {"vhs", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vhs", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vhs", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vhs", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vhs", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vhs", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vhs", "mnsync", &mnsync, true, true, false},
        {"vhs", "spork", &spork, true, true, false},
        {"vhs", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vhs", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vhsd, or the -server option to vhs-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vhs-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13201/\n";
}
