...
#   c) node1 mines 32 blocks, so now node 0 has 60001vhs, node 1 has 4250vhs, node2 has none.
#   d) node0 sends 601 vhs to node2, in two transactions (301 vhs, then 300 vhs).
